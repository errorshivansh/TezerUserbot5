...
class Config((object)):
    ...
    ASSISTANT_START_PIC = os.environ.get(
        "ASSISTANT_START_PIC", "https://telegra.ph/file/7f6a2204f4461ad9c9b99.jpg"
    )
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/TeamTezer/TezerUserbot"
    )
    ALIVE_IMG = os.environ.get(
        "ALIVE_IMG", "https://telegra.ph/file/7f6a2204f4461ad9c9b99.jpg"
    )
    U_BRANCH = "master"
    ...
    XTRA_PLUGINS_REPO = os.environ.get("XTRA_PLUGINS_REPO", "https://github.com/TeamTezer/Xtra-Plugins")
